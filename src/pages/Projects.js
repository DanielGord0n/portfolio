...
import launchpathLogo from '../images/launchpathLogo.png';
import laurierLogo from '../images/wilfrid-laurier-university-seeklogo.png';
...
const caseStudies = [
  ...
  },
  {
    ...
    description:
      'An AI-powered medication assessment and dosage guidance app. Users complete a dynamic 15-step health questionnaire, and the backend builds a structured prompt for Google Gemini that returns dosage recommendations with step-by-step mathematical reasoning.',
    highlights: [
...
const projects = [
  ...
  },
  {
    ...
    image: dgLogo,
    description:
      'The site you are on. A programmatic title sequence rendered in React with Remotion, an animated SVG telemetry gauge cluster, a 3D skill sphere built with spherical-coordinate math and CSS transforms (no WebGL), and physics-based card tilt via Framer Motion. The design system is hand-rolled CSS variables. No Tailwind, no component library.',
    tags: ['React 19', 'Remotion', 'Framer Motion 12', 'Vanilla CSS', 'Vercel'],
  ...
  >
    <div className="case-study-body">
      ...
      <div className="case-title-row">
        {study.logo && <img src={study.logo} alt={`${study.title} logo`} className="case-logo" />}
