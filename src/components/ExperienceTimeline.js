...
const experiences = [
    ...
    },
    {
        ...
        description: [
            'Designed and shipped Phoenix Bot, a cross-platform Electron desktop app (macOS, Windows, Linux) automating WhatsApp group chat summarization via Google Gemini. Solved the core challenge of sustaining a persistent Puppeteer/headless-Chrome session inside an Electron main process, with OS keychain credential storage and local SQLite for session state.'
        ]
    },
    {
        id: 6,
